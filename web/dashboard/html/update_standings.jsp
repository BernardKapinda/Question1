        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">         
                    ...
                    <center>Put Your JSON File Containing The Match Results In The <strong>C:</strong> Directory & Rename it to <strong>match_results.json</strong> and Click On The Button Below</center><br>
                    <form action='process_update_standings.jsp' method="post">
                        
                        <center><input type="password" name="pwd" placeholder="Password" class="text-center" required="Enter Password"><br><br>
                        <input type="submit" class="btn btn-facebook" value="Update Match Results"></center>
